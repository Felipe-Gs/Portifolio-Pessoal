    ...
    return(
        ...
        <div style={{backgroundColor:'gray'}} className='Habilidades'>
            ...
            <div className='grafico'>
                <Particulas/>
                <div className='barra'>
                    Python<ProgressBar style={{width:'85%'}}  variant='success' now={90}animated label={'90%'}/>  </div>  <br/>
                <div className='barra'>
                ...
                <div className='barra'>
                    ReactJs<ProgressBar style={{width:'85%'}}  variant='success' now={40}animated label={'40%'}/>
                </div>
                <br/>
                <div className='barra'>
